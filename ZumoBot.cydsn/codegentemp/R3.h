...
*/
     ...
     *  @{
     */
        #define R3_INTR_NONE      (uint16)(0x0000u)
        #define R3_INTR_RISING    (uint16)(0x0001u)
        #define R3_INTR_FALLING   (uint16)(0x0002u)
        #define R3_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define R3_INTR_MASK      (0x01u) 
#endif /* (R3__INTSTAT) */
...
/* SIO registers */
#if defined(R3__SIO_CFG)
    #define R3_SIO_HYST_EN        (* (reg8 *) R3__SIO_HYST_EN)
    #define R3_SIO_REG_HIFREQ     (* (reg8 *) R3__SIO_REG_HIFREQ)
    #define R3_SIO_CFG            (* (reg8 *) R3__SIO_CFG)
    #define R3_SIO_DIFF           (* (reg8 *) R3__SIO_DIFF)
#endif /* (R3__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define R3_0_INTTYPE_REG 		(* (reg8 *) R3__0__INTTYPE)
#endif /* (R3__INTSTAT) */
